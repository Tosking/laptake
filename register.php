        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
            <div class="input-group input-group-sm mx-auto mb-5 w-75 row">
                <input type="text" class="justify-content-center form-control reg_place"
                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Имя"
                    name="fname" value="<?php if(isset($_POST["fname"])){echo $_POST["fname"];}?>">
            </div>
            <div class="input-group input-group-sm mx-auto mb-5 w-75 row">
                <input type="text" class="justify-content-center form-control reg_place"
                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Фамилия"
                    name="sname" value="<?php if(isset($_POST["sname"])){echo $_POST["sname"];}?>">
            </div>
            <div class="input-group input-group-sm mx-auto mb-5 w-75 row">
                <input type="text" class="justify-content-center form-control reg_place"
                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Логин"
                    name="login" value="<?php if(isset($_POST["login"])){echo $_POST["login"];}?>">
            </div>
            <div class="input-group input-group-sm mx-auto mb-5 w-75 row">
                <input type="text" class="justify-content-center form-control reg_place"
                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Email"
                    name="email" value="<?php if(isset($_POST["email"])){echo $_POST["email"];}?>">
            </div>
            <div class="input-group input-group-sm mx-auto mb-5 w-75 row">
                <input type="password" class="justify-content-center form-control reg_place"
                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Пароль"
                    name="pass">
            </div>
            <div class="input-group input-group-sm mx-auto mb-5 w-75 row">
                <input type="password" class="justify-content-center form-control reg_place"
                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"
                    placeholder="Подтвердите пароль" name="confpass">
            </div>
            <?php
            if(isset($msg)){
        ...
        ?>
            <div class="text-center">
                <button type="submit" class="btn btn-primary w-50 btn-lg btn-dark row mb-3"
                    style="border-radius: 27px;font-family: \'Montserrat\'; font-weight: 900;">Регистрация</button>
            </div>
        </form>
        <div class="mb-3">
